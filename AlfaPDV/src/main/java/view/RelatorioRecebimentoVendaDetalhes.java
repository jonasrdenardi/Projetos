...
public class RelatorioRecebimentoVendaDetalhes extends javax.swing.JInternalFrame {
    ...
    public RelatorioRecebimentoVendaDetalhes(int idVenda) {
        initComponents();
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        new Relatorio(
                "rpt_detalhesVenda", //nome do relatório
