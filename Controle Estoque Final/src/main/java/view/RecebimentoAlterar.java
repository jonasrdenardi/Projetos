...
public class RecebimentoAlterar extends javax.swing.JInternalFrame {
    ...
    public RecebimentoAlterar() {
        initComponents();
        configurarFormulario();

        recebimentos = new RecebimentoDAO().listar(Menu.getUsuario());
    ...
    private void initComponents() {
        ...
        lblRelatorioVenda.setText("ALTERAR RECEBIMENTO");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jpData, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(17, 17, 17)))
                .addComponent(jspResultados, javax.swing.GroupLayout.PREFERRED_SIZE, 381, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void txtPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaKeyReleased
        ...
        if (chave.isEmpty()) {
            ...
            recebimentos = new RecebimentoDAO().pesquisarPorIdVenda(Menu.getUsuario(), Integer.valueOf(txtPesquisa.getText()));
            preencherTabela();
        } else if (rbNome.isSelected()) {
            //recebimentos = new VendaDAO().pesquisarClienteVendaPorNome(Menu.getUsuario(), txtPesquisa.getText());
            preencherTabela();
        }
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if (jdcData.getDate() == null) {
            ...
            recebimentos = new RecebimentoDAO().pesquisarPorDataRecebimento(Menu.getUsuario(), jdcData.getDate());
            preencherTabela();
        }
    ...
    private void configurarTabela() {
        ...
        m.addColumn("Nº Parcela");
        m.addColumn("Data de Recebimento");
        m.addColumn("Valor Recebido");
        m.addColumn("Modo de Pagamento");
        m.addColumn("Ativo");
        
        tabResultados.setModel(m);

        tabResultados.getColumnModel().getColumn(0).setPreferredWidth(5);
        tabResultados.getColumnModel().getColumn(1).setPreferredWidth(5);
        tabResultados.getColumnModel().getColumn(2).setPreferredWidth(10);
        tabResultados.getColumnModel().getColumn(3).setPreferredWidth(90);
        tabResultados.getColumnModel().getColumn(4).setPreferredWidth(70);
        tabResultados.getColumnModel().getColumn(5).setPreferredWidth(120);
        ...
        tabResultados.getColumnModel().getColumn(3).setCellRenderer(centralizado);
        ...
        if (recebimentos.size() > 0) {
            ...
            for (Recebimento r : recebimentos) {
                m.addRow(new Object[]{
                    ...
                    r.getId_venda(),
                    r.getNum_parcela(),
                    sdfNormal.format(r.getData_recebimento()),
                    dm.format(r.getValor_recebido()),
                    r.getModo_Pgto(),
                    (r.getFg_ativo() == true) ? "Sim" : "Não"
                });
            }
            tabResultados.setModel(m);
        }
