...
public class RelatorioRecebimento extends javax.swing.JInternalFrame {
    ...
    private void txtPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaKeyReleased
        ...
        if (chave.isEmpty()) {
            ...
            recebimentos = new VendaDAO().pesquisarClienteVendaPorId(Menu.getUsuario(), Integer.valueOf(txtPesquisa.getText()));
            preencherTabela();
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if (jdcData1.getDate() == null || jdcData2.getDate() == null) {
            ...
            recebimentos = new VendaDAO().pesquisarClienteVendaPorData(Menu.getUsuario(), jdcData1.getDate(), jdcData2.getDate());
            preencherTabela();
        }
    ...
    private void configurarTabela() {
        ...
        tabResultados.getColumnModel().getColumn(0).setPreferredWidth(10);
        tabResultados.getColumnModel().getColumn(1).setPreferredWidth(10);
        tabResultados.getColumnModel().getColumn(2).setPreferredWidth(10);
        tabResultados.getColumnModel().getColumn(3).setPreferredWidth(40);
        tabResultados.getColumnModel().getColumn(4).setPreferredWidth(50);
        tabResultados.getColumnModel().getColumn(5).setPreferredWidth(70);
        tabResultados.getColumnModel().getColumn(6).setPreferredWidth(20);
