...
public class RelatorioFinanceiro extends javax.swing.JInternalFrame {
    ...
    public RelatorioFinanceiro() {
        ...
        retornos = new RetornoDAO().listarVendaEClienteERecebimento(Menu.getUsuario());
    ...
    private void initComponents() {
        ...
        lblRelatorioVenda.setText("RELATÓRIO FINANCEIRO");
        ...
        btnAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/imprimir1.png"))); // NOI18N
        btnAlterar.setBorder(null);
        btnAlterar.setBorderPainted(false);
        btnAlterar.setContentAreaFilled(false);
        btnAlterar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnAlterar.setFocusPainted(false);
        btnAlterar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/images/imprimir2.png"))); // NOI18N
        btnAlterar.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/images/imprimir2.png"))); // NOI18N
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (txtPesquisa.getText().isEmpty() || txtPesquisa.getText().equalsIgnoreCase("Digite sua pesquisa aqui!") || jdcData1.getDate() == null || jdcData2.getDate() == null) {
                param.put("PARAM", "");
                new Relatorio(
    ...
    private void btnDetalhesRecebimentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalhesRecebimentoActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            RelatorioFinanceiroDetalhesRecebimento jiDetalhesRecebimento = new RelatorioFinanceiroDetalhesRecebimento(retorno);
    ...
    private void configurarFormulario() {
        this.setTitle("Relatório Financeiro");
