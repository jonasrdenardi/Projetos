...
public class Recebimento extends javax.swing.JFrame {
    ...
    private void btnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterActionPerformed
        ...
        String update_qtd = "UPDATE tb_produto SET quantidade =";
        String where_qtd = " WHERE cod_produto =";
        String sql_qtd = update_qtd + qtdProduto + where_qtd + codItem;

        float psProduto = Integer.parseInt(txtPeso.getText());
        String update_ps = "UPDATE tb_produto SET peso =";
        String where_ps = " WHERE cod_produto =";
        String sql_ps = update_ps + psProduto + where_ps + codItem;

        try {
            conexao = DriverManager.getConnection("jdbc:postgresql://localhost:5432/HORTFRUTT", "postgres", "147258");
            PreparedStatement statementQtd = conexao.prepareStatement(sql_qtd);
            PreparedStatement statementPs = conexao.prepareStatement(sql_ps);
            int resultset = statementQtd.executeUpdate();
            float resultset2 = statementPs.executeUpdate();

        } catch (SQLException e) {
            Logger.getLogger(Recebimento.class.getName()).log(Level.SEVERE, null, e);
    ...
    private void txtPesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPesoActionPerformed
        ...
        int codItem = Integer.parseInt(txtItem.getText());
        int psProduto = Integer.parseInt(txtPeso.getText());
    ...
    private void btnOkEanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkEanActionPerformed
        ...
        int numEan = Integer.parseInt(txtEan.getText());
