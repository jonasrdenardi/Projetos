...
public class FinanceiroAbrir extends javax.swing.JInternalFrame {

    SimpleDateFormat sdfNormal = new SimpleDateFormat("dd/MM/yyyy");
    DecimalFormat dm = new DecimalFormat(("###,###,###,###,##0.00"));
    Venda venda = new Venda();

    public FinanceiroAbrir(Venda venda, String cliente) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnGerar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/gerar1.png"))); // NOI18N
        ...
        btnGerar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/images/gerar2.png"))); // NOI18N
        btnGerar.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/images/gerar2.png"))); // NOI18N
