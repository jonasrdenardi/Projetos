...
public class FinanceiroAlterarSelectVenda extends javax.swing.JInternalFrame {
    ...
    public FinanceiroAlterarSelectVenda() {
        initComponents();
    ...
    private void btnDetalhesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalhesActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            FinanceiroAlterarDetalhe jiVendaDetalhes = new FinanceiroAlterarDetalhe(idVenda);
...
// Pega o indice da linha selecionada
        ...
        if (indiceLinha != -1) {
            ...
            FinanceiroAlterar jiRecebimentoAlterar = new FinanceiroAlterar(retorno);
