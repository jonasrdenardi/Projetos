...
public class FinanceiroAbrirSelectVenda extends javax.swing.JInternalFrame {
    ...
    public FinanceiroAbrirSelectVenda() {
        initComponents();
    ...
    private void btnDetalhesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalhesActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            FinanceiroAbrirDetalhe jiVendaDetalhes = new FinanceiroAbrirDetalhe(idVenda);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            FinanceiroAbrir jiRecebimentoAbrir = new FinanceiroAbrir(venda, cliente);
