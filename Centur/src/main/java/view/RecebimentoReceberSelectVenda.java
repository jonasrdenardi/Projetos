...
public class RecebimentoReceberSelectVenda extends javax.swing.JInternalFrame {
    ...
    public RecebimentoReceberSelectVenda() {
        initComponents();
    ...
    private void btnDetalhesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalhesActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            RecebimentoReceberDetalhe jiVendaDetalhes = new RecebimentoReceberDetalhe(idVenda);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            RecebimentoReceberSelectRecebimento jiRecebimentoReceberSelectRecebimento = new RecebimentoReceberSelectRecebimento(retorno);
