...
public class FinanceiroReceberSelectRecebimento extends javax.swing.JInternalFrame {
    ...
    public FinanceiroReceberSelectRecebimento(Retorno retorno, FinanceiroReceberSelectVenda jiFinanceiroReceberSelectVenda) {
        initComponents();
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            FinanceiroReceber jiRecebimentoReceber = new FinanceiroReceber(recebimento, jiFinanceiroReceberSelectVenda);
