...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu(Usuario usuario) {
        ...
        if (usuario.getNome().equals("pamela") || usuario.getNome().equals("centur") || usuario.getNome().equals("cronos") || usuario.getNome().equals("cassia") || usuario.getNome().equals("root")) {
