...
public class FinanceiroAlterar extends javax.swing.JInternalFrame {
    ...
    public FinanceiroAlterar(Retorno retorno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jdcAVista = new com.toedter.calendar.JDateChooser();
        jLabel3 = new javax.swing.JLabel();
        jpParcelado = new javax.swing.JPanel();
        cbModoPgtoParcelado = new javax.swing.JComboBox<>();
        jLabel1 = new javax.swing.JLabel();
        jdcParcelado = new com.toedter.calendar.JDateChooser();
        ...
        jpAVistaLayout.setHorizontalGroup(
            ...
            .addGroup(jpAVistaLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jdcAVista, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        jpAVistaLayout.setVerticalGroup(
            ...
            .addGroup(jpAVistaLayout.createSequentialGroup()
                .addGap(2, 2, 2)
                .addGroup(jpAVistaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpAVistaLayout.createSequentialGroup()
                        .addComponent(cbModoPgtoAVista, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(jdcAVista, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jpParceladoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpParceladoLayout.createSequentialGroup()
                        .addGroup(jpParceladoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jdcParcelado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(22, 22, 22)
    ...
    private void btnParcelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnParcelarActionPerformed
        ...
        if (jdcParcelado.getDate() != null) {
            //Converte util.Date em LocalDate
            LocalDate primeiraParcela = jdcParcelado.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
...
//        Date date = Date.from(localDate.atStartOfDay(ZoneId.systemDefault()).toInstant());
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (rbAVista.isSelected()) {
            ...
            recebimento.setData_recebimento(jdcAVista.getDate());
            ...
            int res = new RecebimentoDAO().removerPorIdVenda(Menu.getUsuario(), recebimento.getId_venda());

            if (res != -1) {
                recebimento.setId(new RecebimentoDAO().inserir(Menu.getUsuario(), recebimento));
                if (recebimento.getId() == -1) {
                    JOptionPane.showMessageDialog(null, "Erro ao alterar Recebimento! ID Venda: " + recebimento.getId_venda());
                } else if (new VendaDAO().alterarFg_ativo(Menu.getUsuario(), recebimento.getId_venda(), false) == -1) {
                    JOptionPane.showMessageDialog(null, "Erro ao alterar fg_ativo de Venda! ID Venda: " + recebimento.getId_venda());
                } else {
                    JOptionPane.showMessageDialog(null, "Recebimento(s) alterado(s) com sucesso!");
                    dispose();
                }
            } else {
                JOptionPane.showMessageDialog(null, "Erro ao alterar Recebimento! ID Venda: " + recebimento.getId_venda());
            ...
            int res = new RecebimentoDAO().removerPorIdVenda(Menu.getUsuario(), Integer.valueOf(txtIdVenda.getText()));
            if (res != -1) {
                ...
                if (new VendaDAO().alterarFg_ativo(Menu.getUsuario(), Integer.valueOf(txtIdVenda.getText()), false) == -1) {
                    JOptionPane.showMessageDialog(null, "Erro ao alterar fg_ativo de Venda! ID Venda: " + Integer.valueOf(txtIdVenda.getText()));
                } else if (!gerouErro) {
                    JOptionPane.showMessageDialog(null, "Recebimento(s) alterado(s) com sucesso!");
                    dispose();
                }
            }else{
                JOptionPane.showMessageDialog(null, "Erro ao alterar Recebimento! ID Venda: " +  Integer.valueOf(txtIdVenda.getText()));
            }
        }
    ...
    private com.toedter.calendar.JDateChooser jdcAVista;
    private com.toedter.calendar.JDateChooser jdcParcelado;
    ...
    private void configurarFormulario() {
        ...
        List<Recebimento> recebimentos = new ArrayList<>();
        recebimentos = new RecebimentoDAO().listarIdVendaOrderDataRecebimentoAsc(Menu.getUsuario(), retorno.venda.getId());

        if (recebimentos.size() > 0) {
            if (recebimentos.get(0).getModo_Pgto().contains("À Vista")) {
                rbAVista.setSelected(true);
                jpAVista.setVisible(true);
                jpParcelado.setVisible(false);
                taAVista.setText(recebimentos.get(0).getObs());
                jdcAVista.setDate(recebimentos.get(0).getData_recebimento());
                switch (recebimentos.get(0).getModo_Pgto()) {
                    case "À Vista | Dinheiro": {
                        cbModoPgtoAVista.setSelectedIndex(0);
                        break;
                    }
                    case "À Vista | Débito": {
                        cbModoPgtoAVista.setSelectedIndex(1);
                        break;
                    }
                    case "À Vista | Cheque": {
                        cbModoPgtoAVista.setSelectedIndex(2);
                        break;
                    }
                }
            } else {
                ...
                jpAVista.setVisible(false);
                jpParcelado.setVisible(true);
                taParcelado.setText(recebimentos.get(0).getObs());
                spParcelas.setValue(recebimentos.size());
                jdcParcelado.setDate(recebimentos.get(0).getData_recebimento());
                switch (recebimentos.get(0).getModo_Pgto()) {
                    case "Parcelado | Crédito": {
                        cbModoPgtoParcelado.setSelectedIndex(0);
                        break;
                    }
                    case "Parcelado | Cheque": {
                        cbModoPgtoParcelado.setSelectedIndex(1);
                        break;
                    }
                    case "Parcelado | Indefinido": {
                        cbModoPgtoParcelado.setSelectedIndex(2);
                        break;
                    }
                }
                for (Recebimento recebimento : recebimentos) {
                    preencherTabela(recebimento.getNum_parcela(), recebimento.getData_recebimento(), recebimento.getValor_recebido());
                }
            }
        }
    ...
    public void preencherTabela(int numeroParcela, Date vencimento, float valor) {
