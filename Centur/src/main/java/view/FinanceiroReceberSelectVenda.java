...
public class FinanceiroReceberSelectVenda extends javax.swing.JInternalFrame {
    ...
    public FinanceiroReceberSelectVenda() {
        initComponents();
        configurarFormulario();

        retornos = new RetornoDAO().listarVendaEClienteERecebimentoAberto(Menu.getUsuario());
    ...
    private void initComponents() {
        ...
        lblRelatorioVenda.setText("SELECIONAR VENDA PARA RECEBER");
        ...
        btnAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/selecionar1.png"))); // NOI18N
        btnAlterar.setBorder(null);
        btnAlterar.setBorderPainted(false);
        btnAlterar.setContentAreaFilled(false);
        btnAlterar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnAlterar.setFocusPainted(false);
        btnAlterar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/images/selecionar2.png"))); // NOI18N
        btnAlterar.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/images/selecionar2.png"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(210, 210, 210)
                        .addComponent(btnDetalhesRecebimento)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void txtPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaKeyReleased
        ...
        if (chave.isEmpty()) {
            ...
            retornos = new RetornoDAO().listarVendaEClienteERecebimentoPesquisarPorId(Menu.getUsuario(), Integer.valueOf(txtPesquisa.getText()));
            preencherTabela();
        } else if (rbNome.isSelected()) {
            retornos = new RetornoDAO().listarVendaEClienteERecebimentoPesquisarPorNome(Menu.getUsuario(), txtPesquisa.getText());
            preencherTabela();
        }
    ...
    private void btnDetalhesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalhesActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            FinanceiroReceberDetalhe jiVendaDetalhes = new FinanceiroReceberDetalhe(idVenda);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if (jdcData1.getDate() == null || jdcData2.getDate() == null) {
            ...
            retornos = new RetornoDAO().listarVendaEClienteERecebimentoPesquisarPorData(Menu.getUsuario(), jdcData1.getDate(), jdcData2.getDate());
            preencherTabela();
        }
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            FinanceiroReceberSelectRecebimento jiRecebimentoReceberSelectRecebimento = new FinanceiroReceberSelectRecebimento(retorno,this);
            Menu.areaTrabalho.add(jiRecebimentoReceberSelectRecebimento);
            jiRecebimentoReceberSelectRecebimento.setVisible(true);
            jiRecebimentoReceberSelectRecebimento.setPosicao();  // Centraliza a Tela Interna
            //this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Selecione uma venda!");
        }
    ...
    private void btnDetalhesRecebimentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalhesRecebimentoActionPerformed
        ...
        if (indiceLinha != -1) {
            ...
            FinanceiroAlterarDetalhesRecebimento jiRecebimentoAlterarDetalhesRecebimento = new FinanceiroAlterarDetalhesRecebimento(retorno);
