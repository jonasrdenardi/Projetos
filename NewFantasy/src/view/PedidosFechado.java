...
public class PedidosFechado extends javax.swing.JInternalFrame {

    public PedidosFechado() {
        initComponents();
        this.setTitle("Pedido Fechado - New Fantasy");
        // Chama o metodo listar do PedidoDAO passando o usuário de login como parametro
        preencherTabela(new PedidoDAO().listarFechado(Menu.getUsuario()));
    }
