...
public class PedidosAlterar extends javax.swing.JInternalFrame {

    DecimalFormat dm = new DecimalFormat("0.00");

    public PedidosAlterar(int idPedido) {
        initComponents();
        configurarFormulario();
        lblVIdPedido.setText(String.valueOf(idPedido));
        preencherTabelaItem(new ItemDAO().listarAtivos(Menu.getUsuario()));
        preencherTabelaItemPedidoInicio(new PedidoDAO().listarDetalhes(Menu.getUsuario(), idPedido));
        setMesas(new MesaDAO().listarAtiva(Menu.getUsuario()));

        Pedido pedido = new Pedido();
        pedido = new PedidoDAO().listarDetalhes(Menu.getUsuario(), idPedido);

        if (pedido.getGarcom10() != 0) {
            set10GarcomETotal();
            jcb10Garcom.setSelected(true);
        } else {
            setTotalSemGarcom();
    ...
    private void initComponents() {
        ...
        lblVIdPedido = new javax.swing.JLabel();
        ...
        lblIdIPedido = new javax.swing.JLabel();
        ...
        lblVIdPedido.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N

        btnAlterarPedido.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnAlterarPedido.setText("ALTERAR");
        btnAlterarPedido.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnAlterarPedido.setBorderPainted(false);
        btnAlterarPedido.setContentAreaFilled(false);
        btnAlterarPedido.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        lblIdIPedido.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblIdIPedido.setText("Pedido: ");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(37, 37, 37)
                                        .addComponent(btnAlterarPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(10, 10, 10)
                                .addComponent(lblIdIPedido)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lblVIdPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(147, 147, 147)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jcb10Garcom)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnAlterarPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(11, 11, 11))
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(lblIdIPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(lblVIdPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnAlterarPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarPedidoActionPerformed
        if (tblItemPedido.getRowCount() != 0) {
            ...
            p.setId(Integer.parseInt(lblVIdPedido.getText()));
            ...
            // Deleta todos os itens do pedido retornando quantos itens foram excluidos
            int retorno = new ItemPedidoDAO().deletar(Menu.getUsuario(), p.getId());

            if (retorno != -1) {
                // Insere os novos itens e os itens alterados
                int res = (new ItemPedidoDAO().inserir(Menu.getUsuario(), p));
                if (res != -1) {
                    res = 0;
                    // Alterar valor Garcom e Total pedido
                    res = new PedidoDAO().alterarValorGarcomETotal(Menu.getUsuario(), p);
                    if (res != -1) {
                        JOptionPane.showMessageDialog(null, "Pedido " + p.getId() + " alterado com sucesso");
                    } else {
                        JOptionPane.showMessageDialog(null, "Erro ao alterar pedido: " + p.getId() + "\n" + "Função: Alterar valor Garcom e Total pedido");
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Erro ao alterar pedido: " + p.getId() + "\n" + "Função: inserir itens novos e alterados no banco");
                }
            } else {
                JOptionPane.showMessageDialog(null, "Erro ao alterar pedido: " + p.getId() + "\n" + "Função: deletar itens antigos");
            }
    ...
    private javax.swing.JLabel lblIdIPedido;
    ...
    private javax.swing.JLabel lblVIdPedido;
    ...
    private void configurarFormulario() {
        this.setTitle("Alterar Pedido - New Fantasy");
    ...
    // preenche tabela ItemPedido no construtor
    public void preencherTabelaItemPedidoInicio(Pedido p) {
        if (p != null) {
            ...
            for (int i = 0; i < p.getItem().length; i++) {
                ...
                m.addRow(new Object[]{p.getItem(i).getId(), p.getItem(i).getDesc(), p.getQtdItem(i).getQtdItem(), dm.format(p.getItem(i).getValor()), dm.format(p.getQtdItem(i).getQtdItem() * p.getItem(i).getValor())});
